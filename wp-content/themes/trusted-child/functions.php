...
// Excluir exibição da versão do Wordpress 30/04/2022
remove_action('wp_head', 'wp_generator');

// Adicionar imagem ao gravatar de usuario que não tem foto 30/04/2022
add_filter( 'avatar_defaults', 'bl_avatar' );
function bl_avatar($avatar_defaults) {
  $novo_avatar = '../wp-content/uploads/2020/10/logo_diamond.png';
  $avatar_defaults[$novo_avatar] = "DiamondNautica";
    return $avatar_defaults;
}

// Adicionar miniaturas de imagens no compartilhamento de imagens 30/04/2022
add_theme_support('post-thumbnails');

// Adiciona resumo para páginas 30/04/2022
add_action( 'init', 'bl_excerpts_pages' );
function bl_excerpts_pages() {
  add_post_type_support( 'page', 'excerpt' );
}

// Adicionar miniatura de post ao RSS 30/04/2022
...
function after_add_to_cart_btn(){
    echo '</br></br><img src="https://diamondnautica.com.br/wp-content/uploads/2020/07/icone_seguranca.png" width="50" /><a href="https://diamondnautica.com.br/compra-garantida/" target="_blank"> Compra Garantida</a>, receba seu produto com segurança.';
}
/*==================================================================
				...
				<tr>
					...
					<?php
						...
						if($nome_transportadora == 'Correios') {
							...
							<?php
						} else if($nome_transportadora == 'Postex Express') {
							//Escreve o código de rastreio
							?>
								<p style="text-align: center; color:green;">C&oacute;digo de Rastreio: <spam style="font-size:17px; color:blue;"><?php echo $rastreio;?></spam></p>
							<?php
						...
						<p style="font-size:11px;">Pedido Enviado</br>							
							...
							<?php
								...
								if($nome_transportadora == 'Correios') {
									...
									//Mostra link para a página de rastreio dos correios
									?>
										<spam style="font-size:11px;"><a href="https://www.postexexpress.com.br/rastreamento" target="_blank">Rastrei seu pedido</a></spam></br>
									<?php
								} else {
									?>
			...
			<table>
				<tr>
					...
					<?php
						...
						} else if(trim($consulta_frete['nome_transportadora']) == 'Postex Express') {
							//Escreve o código de rastreio
							?>
							<p style="text-align: center; color:green;">C&oacute;digo de Rastreio: <spam style="font-size:17px; color:blue;"><?php echo $consulta_frete['rastreio'];?></spam></p>
						<?php
...
function painel_novo() {
	...
	<!-- Bloco principal -->
		...
		<a href="../product/churrasqueira-noxfortt-aco-inox-espeto-rotativo-nautica-e-lazer/">
				...
				//	if( $user_id == 1 ) {
						?>
							<div id="wrapperContentBannerEsporteAquatico">
								...
								<img src="../wp-content/uploads/2022/05/churrasqueira-noxfortt-5.webp" id="imgEsporteAquatico" />
								<div id="textosBannerEsporteAquatico">
									<p id="nomeVerao">Churrasqueira Noxfortt</p>
									<p id="nomeCombina">Elétrica quadrivolt</p>
									<p id="subtituloGarante">Em aço inox 316</p>
								</div>
							</div>
						<?php
					//}
...
/**
 * Teste de construção de página utilizando React dentro do Wordpress
 */
add_shortcode('app_web', 'app_web_home');
function app_web_home() {	
	if( current_user_can('administrator') ) {
		?>
			<div id="app_web_root"></div>
